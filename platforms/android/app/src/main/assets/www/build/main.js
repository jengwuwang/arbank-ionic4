...
var TranferenciaPage = (function () {
            ...
            self.storage.get('idToken').then(function (val) {
                ...
                var httpOptions = {
                    headers: new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]({
                        ...
                        // 'user-key': '1234567890123',
                        'Authorization': 'eyJraWQiOiJyWVE1cFd3OHRtMFBqUjUxMEt1K2hkM3JxOCs3czRPOStGWWJjckdncW93PSIsImFsZyI6IlJTMjU2In0..DVNJCatqKSn5YKqeafVCh77d0MmAl2KLVPFQdDMlNHem6gIuomQb1mevrqgJkPx6dhq8dZiNj1qMBylyZ1zRE_GlStBw-WVb-M9hmMn2hbTl8fBf__8jAc1h5HUiTa6YVubbjeWBcKj80VE6_mgl1ykf3JZTblAYF3lg7WK68lyS9j-0R3E-liZ2ygrb7vIFQqx1hB_Su2BoHHAqhb9kK_9yRxxA_d-MndVp9s0Dl8ou7Y04CuIllkzJ4TPfve8PHggPDYjzZuoALCiYzukSC0Sll0ywNcPqfDqukRRXU4isocboBZhX_ntcSDwMpscdxNywgY_mSqw6p8Io9lxITg',
                    })
                };
                _this.http.get(apiUrlForAccountID, httpOptions).subscribe(function (result) {
                    _this.products = result;
                    console.log(_this.products);
                    self.storage.set('account_id', _this.account_id);
    ...
    TranferenciaPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */]])
    ], TranferenciaPage);
...
var TransferenciaTerceiraPage = (function () {
    ...
    TransferenciaTerceiraPage.prototype.onSenhaTrans = function () {
        ...
        var apiUrlForStep3Transfer = 'https://sandbox.conductor.com.br/pier/v2/api/contas/17/transferencias-creditos-cartoes?id_conta_destino=24&valor_transferencia=' + this.brlValue;
...
var SenhaPagamentoPage = (function () {
    function SenhaPagamentoPage(navCtrl, navParams, fb, http, toastController) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.fb = fb;
        this.http = http;
    ...
    SenhaPagamentoPage.prototype.onComprovanteConta = function () {
        ...
        if (self.confirmPasswordForm.valid) {
            var apiUrlForConfirmPassword = 'https://sandbox.conductor.com.br/pier/v2/api/cartoes/24/validar-senha';
            var httpOptions = {
                headers: new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["c" /* HttpHeaders */]({
                    // 'Accept': '/',
                    // 'Access-Control-Allow-Credentials': 'true',
    ...
    SenhaPagamentoPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */]])
    ], SenhaPagamentoPage);
