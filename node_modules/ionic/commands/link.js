...
Ionic Appflow uses a git-based workflow to manage app updates. During the linking process, select ${chalk_1.default.bold('GitHub')} (recommended) or ${chalk_1.default.bold('Ionic Appflow')} as a git host. See our documentation${chalk_1.default.cyan('[1]')} for more information.
...
${chalk_1.default.cyan('[1]')}: ${chalk_1.default.bold('https://ionicframework.com/docs/appflow/basics/git')}
